...
REQUIRED_DOCUMENTS = {
    ...
    Path("docs/architecture/human-reasoning-engine.md"),
    ...
    Path("docs/architecture/logic-grid-specification.md"),
    Path("docs/architecture/logic-grid-human-rules.md"),
    Path("docs/architecture/logic-grid-backend-encodings.md"),
    Path("docs/architecture/logic-grid-play-session.md"),
    Path("docs/architecture/logic-grid-attempt-persistence.md"),
    ...
    Path("docs/architecture/decisions/0006-verified-human-reasoning-loop.md"),
    Path("docs/architecture/decisions/0007-project-reasoning-as-hypergraph.md"),
    Path("docs/architecture/decisions/0008-gate-generation-on-deterministic-evidence.md"),
    Path("docs/architecture/decisions/0009-derive-memory-views-from-events.md"),
    Path("docs/architecture/decisions/0010-keep-agents-optional-and-non-authoritative.md"),
    ...
    Path("docs/architecture/decisions/0019-persist-play-before-projecting-attempt-evidence.md"),
