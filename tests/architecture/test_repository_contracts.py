...
PUBLIC_PATH_ALLOWLIST = frozenset(
    {
        ...
        "docs/architecture/logic-grid-specification.md",
        "docs/architecture/logic-grid-human-rules.md",
        "docs/architecture/logic-grid-backend-encodings.md",
        "docs/architecture/logic-grid-reference-triad.md",
        ...
        "docs/architecture/logic-grid-assistance.md",
        ...
        "docs/architecture/decisions/0013-model-logic-grid-as-anchor-aligned-bijections.md",
        "docs/architecture/decisions/0014-encode-logic-grid-independently.md",
        ...
        "schemas/logic-grid-spec-v1.schema.json",
        ...
        "schemas/logic-grid-assistance-v1.schema.json",
        ...
        "src/deductra/families/logic_grid/assistance.py",
        ...
        "src/deductra/families/logic_grid/structured_io.py",
        ...
        "src/deductra/verification/logic_grid_cpsat.py",
        "src/deductra/verification/logic_grid_z3.py",
        ...
        "tests/families/logic_grid/test_specification.py",
        "tests/families/logic_grid/test_rules.py",
        "tests/families/logic_grid/test_backend_encodings.py",
        "tests/families/logic_grid/test_golden_triad.py",
        ...
        "tests/families/logic_grid/test_assistance.py",
...
def test_package_contains_only_approved_packet_modules() -> None:
    ...
    assert public_files == {
        ...
        "families/logic_grid/assistance.py",
        ...
        "families/logic_grid/structured_io.py",
        "graph/__init__.py",
        "graph/export.py",
        "graph/model.py",
        "graph/projector.py",
        ...
        "verification/logic_grid_cpsat.py",
        "verification/logic_grid_z3.py",
