...
These documents define how Deductra accepts changes, records decisions, communicates current status, and manages engineering risk.

- [Project governance](project-governance.md) defines authority, change control, review, documentation, and release policy.
