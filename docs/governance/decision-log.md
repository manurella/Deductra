...
| D-029 | Keep tentative Logic Grid play marks separate from proof authority and retain undo, redo, rejection, and branch history through deterministic replay. | Accepted | Repository owner | [ADR-0017](../architecture/decisions/0017-retain-play-history-without-proof-authority.md) |
