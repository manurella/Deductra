...
- [Logic Grid attempt persistence](logic-grid-attempt-persistence.md) defines FAM-LG-009's transactional local history, descriptive action evidence, and authoritative lifecycle projection, and FAM-LG-011's durable, cross-verified move-evaluation log.
- [Logic Grid assistance](logic-grid-assistance.md) defines FAM-LG-010's cross-verified move evaluation, human-rule hint evidence, and progressive disclosure boundary.
